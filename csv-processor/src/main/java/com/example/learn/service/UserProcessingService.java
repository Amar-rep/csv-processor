...
public class UserProcessingService {
    ...
    // public Users createUser(String[] userData, ZipCodeResponse zipCodeResponse,
    // CsvJob job) {
    ...
    // user.setJob(job);
    // user.setAddress(addressService.getOrCreateAddress(userData[2],
    // zipCodeResponse));
    // return userRepository.save(user);
    // }

    // external api
    public Users createUserFromZip(
            String[] userData,
